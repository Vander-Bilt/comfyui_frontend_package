...
const serverConfigItems = {
  ...
  "enable-cors-header": {
    name: '启用 CORS header：使用 "*" 代表所有来源或指定域名'
  },
  fast: {
  ...
  "tls-certfile": {
    name: "TLS 证书文件：HTTPS 的 TLS 证书文件路径"
  },
  "tls-keyfile": {
    name: "TLS 密钥文件：HTTPS 的 TLS 密钥文件路径"
  },
  "unet-precision": {
    name: "UNET 精度",
    tooltip: "UNET 精度"
...
const subgraphStore = {
  blueprintName: "子图名称",
  confirmDelete: "此操作将永久从您的库中移除该子图",
  confirmDeleteTitle: "删除子图？",
  hidden: "隐藏/嵌套参数",
  hideAll: "全部隐藏",
  loadFailure: "加载子图蓝图失败",
  overwriteBlueprint: "保存将用您的更改覆盖当前子图",
  overwriteBlueprintTitle: "覆盖现有子图？",
  publish: "发布子图",
  publishSuccess: "已保存到节点库",
  publishSuccessMessage: "您可以在节点库的“子图蓝图”下找到您的子图蓝图",
  saveBlueprint: "保存子图到节点库",
  showAll: "全部显示",
...
//# sourceMappingURL=main-B28vuueQ.js.map
