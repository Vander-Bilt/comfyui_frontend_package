const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./groupNode-XREk2XmI.js","./index-H9-DogEH.js","./index-Doiq40jE.css","./groupNode-CC55z89j.css"])))=>i.map(i=>d[i]);
...
import { u as useKeybindingService } from "./keybindingService-BcTQ6HHT.js";
import { u as useServerConfigStore } from "./serverConfigStore-BUcDETjp.js";
...
async function ensureGraphHasFluxKontextGroupNode(graph) {
  ...
  const { GroupNodeConfig } = await __vitePreload(async () => {
    const { GroupNodeConfig: GroupNodeConfig2 } = await import("./groupNode-XREk2XmI.js").then((n) => n.b);
...
//# sourceMappingURL=GraphView-B7dW--Y5.js.map
