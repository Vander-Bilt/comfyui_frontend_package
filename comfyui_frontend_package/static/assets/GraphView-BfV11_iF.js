const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./groupNode-CY8LYfuB.js","./index-DC09yfH8.js","./index-BIlrkvoD.css","./groupNode-CC55z89j.css"])))=>i.map(i=>d[i]);
...
import { u as useKeybindingService } from "./keybindingService-BDGnJclf.js";
import { u as useServerConfigStore } from "./serverConfigStore-DzhOV2D6.js";
...
async function ensureGraphHasFluxKontextGroupNode(graph) {
  ...
  const { GroupNodeConfig } = await __vitePreload(async () => {
    const { GroupNodeConfig: GroupNodeConfig2 } = await import("./groupNode-CY8LYfuB.js").then((n) => n.b);
...
//# sourceMappingURL=GraphView-BfV11_iF.js.map
