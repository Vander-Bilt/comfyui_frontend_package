const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./groupNode-DkF4bnOg.js","./index-DBlfa0Ip.js","./index-BIlrkvoD.css","./groupNode-CC55z89j.css"])))=>i.map(i=>d[i]);
...
import { u as useKeybindingService } from "./keybindingService-CHzirV-i.js";
import { u as useServerConfigStore } from "./serverConfigStore-B8Qt4AK1.js";
...
async function ensureGraphHasFluxKontextGroupNode(graph) {
  ...
  const { GroupNodeConfig } = await __vitePreload(async () => {
    const { GroupNodeConfig: GroupNodeConfig2 } = await import("./groupNode-DkF4bnOg.js").then((n) => n.b);
...
//# sourceMappingURL=GraphView-DIJWu9rN.js.map
