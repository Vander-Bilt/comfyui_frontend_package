const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./groupNode-BL32ZO5v.js","./index-CAdFfAbw.js","./index-BIlrkvoD.css","./groupNode-CC55z89j.css"])))=>i.map(i=>d[i]);
...
import { u as useKeybindingService } from "./keybindingService-D3206SW-.js";
import { u as useServerConfigStore } from "./serverConfigStore-Csg1gfBr.js";
...
async function ensureGraphHasFluxKontextGroupNode(graph) {
  ...
  const { GroupNodeConfig } = await __vitePreload(async () => {
    const { GroupNodeConfig: GroupNodeConfig2 } = await import("./groupNode-BL32ZO5v.js").then((n) => n.b);
...
//# sourceMappingURL=GraphView-NQvULl2T.js.map
