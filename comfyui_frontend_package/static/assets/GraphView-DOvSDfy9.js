const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./groupNode-2tCp4Ive.js","./index-C93ilUEM.js","./index-BIlrkvoD.css","./groupNode-CC55z89j.css"])))=>i.map(i=>d[i]);
...
import { u as useKeybindingService } from "./keybindingService-CJ5PuK9i.js";
import { u as useServerConfigStore } from "./serverConfigStore-BqD2SWke.js";
...
async function ensureGraphHasFluxKontextGroupNode(graph) {
  ...
  const { GroupNodeConfig } = await __vitePreload(async () => {
    const { GroupNodeConfig: GroupNodeConfig2 } = await import("./groupNode-2tCp4Ive.js").then((n) => n.b);
...
//# sourceMappingURL=GraphView-DOvSDfy9.js.map
