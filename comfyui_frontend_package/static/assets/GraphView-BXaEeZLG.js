const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./groupNode-dWupdlOk.js","./index-Cgp8FCjT.js","./index-Doiq40jE.css","./groupNode-CC55z89j.css"])))=>i.map(i=>d[i]);
...
import { u as useKeybindingService } from "./keybindingService-nm4dmG3f.js";
import { u as useServerConfigStore } from "./serverConfigStore-citlMIsT.js";
...
async function ensureGraphHasFluxKontextGroupNode(graph) {
  ...
  const { GroupNodeConfig } = await __vitePreload(async () => {
    const { GroupNodeConfig: GroupNodeConfig2 } = await import("./groupNode-dWupdlOk.js").then((n) => n.b);
...
//# sourceMappingURL=GraphView-BXaEeZLG.js.map
